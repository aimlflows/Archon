...
// NETRA Phase 5B Slice 2.1 — droid factory visibility
import { DroidLanesView } from './features/droids';
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      {/* NETRA Phase 5B Slice 2.1 — live droid activity */}
      <Route path="/droids" element={<DroidLanesView />} />
      {styleGuideEnabled ? (
